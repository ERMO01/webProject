<html>
    ...
    <header>
        ...
        <input id="passwordi" type="text" name="password" value="" required placeholder="Password"></p>
        <input id="confirm-pass" type="text" name="password_1" value="" required placeholder="Confirm password"></p>
